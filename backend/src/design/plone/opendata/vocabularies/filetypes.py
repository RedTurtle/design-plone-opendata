...
[
    ...
    {"internet-media-type": "application/zip", "authority-code": "ZIP", "label": "ZIP"},
    {
    ...
    {"internet-media-type": "image/gif", "authority-code": "GIF", "label": "GIF"},
    {"internet-media-type": "image/jpeg", "authority-code": "JPEG", "label": "JPEG"},
    {"internet-media-type": "image/tiff", "authority-code": "TIFF", "label": "TIFF"},
    {"internet-media-type": "image/png", "authority-code": "PNG", "label": "PNG"},
    {
        "internet-media-type": "application/postscript",
        "authority-code": "EPS",
        "label": "Encapsulated Postscript",
    },
    {"internet-media-type": "text/css", "authority-code": "CSS", "label": "CSS"},
    {"internet-media-type": "application/pdf", "authority-code": "PDF", "label": "PDF"},
    {
    ...
    {"internet-media-type": "text/sgml", "authority-code": "FMX2", "label": "Formex 2"},
    {"internet-media-type": "text/sgml", "authority-code": "FMX3", "label": "Formex 3"},
    {
        "internet-media-type": "application/xml",
        "authority-code": "FMX4",
        "label": "Formex 4",
    ...
    {"internet-media-type": "text/sgml", "authority-code": "SGML", "label": "SGML"},
    {
        "internet-media-type": "application/rdf+xml",
    ...
    {"internet-media-type": "application/xml", "authority-code": "XML", "label": "XML"},
    {
    ...
    {"internet-media-type": "text/rtf", "authority-code": "RTF", "label": "RTF"},
    {"internet-media-type": "text/html", "authority-code": "HTML", "label": "HTML"},
    {
        "internet-media-type": "application/xhtml+xml",
        "authority-code": "XHTML",
        "label": "XHTML",
    },
    {"internet-media-type": "text/csv", "authority-code": "CSV", "label": "CSV"},
    {
    ...
    {"internet-media-type": "application/ovf", "authority-code": "OVF", "label": "OVF"},
    {
    ...
    {"internet-media-type": "application/xml", "authority-code": "TMX", "label": "TMX"},
    {
    ...
    {"internet-media-type": "application/sql", "authority-code": "SQL", "label": "SQL"},
    {
        "internet-media-type": "application/pdf",
    ...
    {"internet-media-type": "audio/mpeg", "authority-code": "MPEG2", "label": "MPEG-2"},
    {
    ...
    {"internet-media-type": "audio/vnd.wave", "authority-code": "BWF", "label": "BWF"},
    {
    ...
    {"internet-media-type": "application/zip", "authority-code": "PWP", "label": "PWP"},
    {
    ...
    {"internet-media-type": "image/svg+xml", "authority-code": "SVG", "label": "SVG"},
    {
        "internet-media-type": "application/octet-stream",
        "authority-code": "QGS",
        "label": "QGS",
    },
    {"internet-media-type": "text/n3", "authority-code": "N3", "label": "N3"},
    {
    ...
    {"internet-media-type": "application/zip", "authority-code": "LEG", "label": "LEG"},
    {
        "internet-media-type": "application/xml",
    ...
    {"internet-media-type": "audio/aac", "authority-code": "AAC", "label": "AAC"},
    {
    ...
    {"internet-media-type": "application/x-xz", "authority-code": "XZ", "label": "xz"},
    {
    ...
    {"internet-media-type": "image/vnd.dxf", "authority-code": "DXF", "label": "DXF"},
    {"internet-media-type": "image/vnd.dwg", "authority-code": "DWG", "label": "DWG"},
    {"internet-media-type": "application/zip", "authority-code": "IPA", "label": "IPA"},
    {
    ...
    {"internet-media-type": "text/html", "authority-code": "HTML5", "label": "HTML5"},
    {"internet-media-type": "model/stl", "authority-code": "STL", "label": "StL"},
    {
    ...
    {"internet-media-type": "text/plain", "authority-code": "UNGEN", "label": "Ungen"},
    {
        "internet-media-type": "application/vnd.android.package-archive",
        "authority-code": "OAPK",
        "label": "OAPK",
    ...
    {"internet-media-type": "audio/MPA", "authority-code": "MP3", "label": "MP3"},
    {"internet-media-type": "audio/vnd.wave", "authority-code": "WAV", "label": "WAV"},
    {
    ...
    {"internet-media-type": "image/webp", "authority-code": "WEBP", "label": "WebP"},
    {
        "internet-media-type": "application/gml+xml",
        "authority-code": "WMTS_SRVC",
        "label": "WMTS",
    },
    {"internet-media-type": "video/quicktime", "authority-code": "MOV", "label": "MOV"},
    {
