...
FREQUENCIES = [
    ...
    {'record_id': 'FRQ005', 'authority_code': 'ANNUAL_3', 'label': "tre volte all'anno"},
    ...
    {'record_id': 'FRQ011', 'authority_code': 'MONTHLY_3', 'label': 'tre volte al mese'},
    {'record_id': 'FRQ012', 'authority_code': 'WEEKLY', 'label': 'settimanale'},
    {'record_id': 'FRQ013', 'authority_code': 'WEEKLY_2', 'label': 'bisettimanale'},
    {'record_id': 'FRQ014', 'authority_code': 'WEEKLY_3', 'label': 'tre volte a settimana'},
    {'record_id': 'FRQ015', 'authority_code': 'DAILY', 'label': 'quotidiana'},
    {'record_id': 'FRQ016', 'authority_code': 'UPDATE_CONT', 'label': 'in continuo aggiornamento'},
    {'record_id': 'FRQ017', 'authority_code': 'IRREG', 'label': 'irregolare'},
    {'record_id': 'FRQ019', 'authority_code': 'OTHER', 'label': 'altro'},
    {'record_id': 'FRQ020', 'authority_code': 'DAILY_2', 'label': 'due volte al giorno'},
    {'record_id': 'FRQ021', 'authority_code': 'CONT', 'label': 'continua'},
    {'record_id': 'FRQ022', 'authority_code': 'NEVER', 'label': 'mai'},
    {'record_id': 'FRQ023', 'authority_code': 'QUADRENNIAL', 'label': 'ogni quattro anni'},
    {'record_id': 'FRQ024', 'authority_code': 'QUINQUENNIAL', 'label': 'ogni cinque anni'},
    ...
    {'record_id': 'FRQ032', 'authority_code': 'AS_NEEDED', 'label': 'in base alla necessità'},
...
class DataFrequenciesVocabulary:
    def __call__(self, context):
        terms = [
            SimpleTerm(value=f"http://publications.europa.eu/resource/authority/frequency/{row['authority_code']}", title=row["label"])
